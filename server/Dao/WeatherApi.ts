...
let response=await fetch('https://api.openweathermap.org/data/2.5/weather?q='+location+'&units=metric&appid=45e7e9f3a24de819cbda623615f02d0b')
 ...
 async  weekData(location:string) {
  ...
  let response=await fetch("https://api.weatherbit.io/v2.0/forecast/daily?city="+location+"&key=56508374277d4000840ca85e30a04e5f")
  let data = await response.json();
